...
- Структура:
  ...
  5. Доказательство (источник, дата, страна, ссылка если есть).
  6. ТОЛЬКО ОДИН призыв к действию. Сегодня он такой: «{cta}»
...
- ЕСЛИ НЕТ ПОДХОДЯЩЕЙ НОВОСТИ — верни пустой ответ (ничего не пиши)."""
    ...
    # Если модель вернула пустой ответ или отказ — пост не публикуем
